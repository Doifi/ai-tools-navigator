...
export const lobsterZone = {
  title: "龙虾专区",
  subtitle: "把安装包、安装教程和使用教程集中整理到一个入口。",
  description:
    "避免资料散落在聊天记录和网盘里，这里统一收纳龙虾的下载入口、首次安装步骤和日常使用方法。",
  package: {
    name: "龙虾桌面端安装包",
    version: "最新版入口已预留",
    ...
    downloadUrl: "",
    description:
      "这里预留龙虾安装包的统一下载入口。拿到正式下载地址后，只需补上链接即可直接对外使用。",
    notes: [
  ...
  usageModules: [
    ...
    {
      title: "日常使用流程",
      description: "建议把龙虾放进固定工作流，而不是临时打开后再摸索。",
